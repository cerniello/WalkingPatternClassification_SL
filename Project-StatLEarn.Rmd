...
```{r}
Ivana.df <- read.csv('data_files/Ivana_2walk-Samsung Recording 1-cropped')
Francesco.df <- read.csv('data_files/Francesco_2walk-Samsung Recording 2-cropped')
Michele.df <- read.csv('data_files/Michele_2walk-Samsung Recording 2-cropped')
Francisca.df <- read.csv('data_files/Francisca_2walk-Samsung Recording 1-cropped')
Joanna.df <- read.csv('data_files/Asia_2walk-Samsung Recording 1-cropped')
```
...
cat(sprintf("Train error: %f", err.train))
...
cat(sprintf("Test error: %f", err.test))
```